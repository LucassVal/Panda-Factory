...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Distribution-Hotmart_+_Kiwify-E91E63?style=for-the-badge" alt="Distribution">
...
17 namespaces, one `import`. Auth, AI, payments, distribution, storage, translation — all orchestrated. You write domain logic, Panda handles the plumbing across all 3 layers.

#### 💰 Dev Revenue Share — The Fairest Split in Tech

No SaaS subscription. No per-seat fee. **Panda only earns when you earn.** Up to 85% goes to you. Plus: you earn 40% every time someone USES your module — not just when they buy it. Infrastructure cost: **$0/month** until your first sale.

#### 🐙 Medusa Distribution

Publish to the Panda Medusa Store with `Panda.Store.publish()`. Simultaneously list on Hotmart/Kiwify via webhook. Your product reaches 34M+ buyers through affiliate armies.
...
Every product ships with Gemini AI built-in. Flash for speed, Pro for depth, Think for strategy, Research for citations, Imagen for visuals. Module creators don't write AI code — it's already there.

#### 🔒 Panda Defend

The 4th Layer governs itself. 14 security rules, Ed25519 cryptography, kill switch for compliance enforcement. Your product is protected at the orchestration layer — not at the mercy of lower layers.

#### 🌍 Build for Niches BigTechs Won't Touch

Social automation, prospecting bots, vertical CRMs, trading tools — markets too fragmented for BigTech to address. Panda gives you the SDK, AI, and distribution to own these verticals.
...
## 🟢 Google Ecosystem — Built 100% on Google
...
- **AI included** — Gemini Flash, Pro, Think, Research, Imagen — all accessible via `Panda.Brain`
- **No AWS/Azure needed** — Firebase handles auth, database, hosting. No infra setup
...
### Revenue Split — You Keep the Majority
...
### How Panda Compares to Other Marketplaces
...
<details>
<summary><strong>🏥 Real Scenario: CRM for Dentists (Dr. Patrícia, BH)</strong></summary>
...
<details>
<summary><strong>📱 Real Scenario: Instagram Automation (Coach Marcos, SP)</strong></summary>
...
<details>
<summary><strong>🏠 Real Scenario: Prospecting Bot (Carlos, Realtor, Curitiba)</strong></summary>
...
| --------------------- | --------------------- | ---------------------- |
| `Panda.Auth`          | Firebase Auth         | L1 Infrastructure      |
| `Panda.Brain`         | Gemini AI via GAS     | L3 Tools               |
| `Panda.Canvas`        | TLDraw Editor         | L3 Tools               |
| `Panda.Store`         | Medusa Marketplace    | L2 Platform            |
| `Panda.Wallet`        | Ed25519 + GAS Ledger  | L1 + L2                |
| `Panda.Google.Drive`  | Google Drive API      | L1 Infrastructure      |
| `Panda.Google.Sheets` | Google Sheets API     | L3 Tools               |
| `Panda.Google.Colab`  | GPU Compute           | L1 Infrastructure      |
| `Panda.Bridge`        | Rust Agent + MCP      | L1 Infrastructure      |
| `Panda.Polyglot`      | NLLB-200 + Whisper    | L3 Tools               |
| `Panda.Collab`        | Yjs CRDT              | L3 Tools               |
| `Panda.Data`          | React Query + Zustand | L3 Tools               |
| `Panda.Storage`       | File Upload/Download  | L1 Infrastructure      |
| `Panda.PAT`           | Economic Toolkit      | L2 Platform            |
| `Panda.Governance`    | Council Validator     | **L4 Self-Governance** |
| `Panda.Validate`      | Zod Schema            | L3 Tools               |
| `Panda.Dock`          | FlexLayout Manager    | L3 Tools               |

> **`Panda.Governance` is the only namespace that doesn't wrap a lower layer — it validates actions against Panda's own rules. This is the 4th Layer governing itself.**
...
// → Product live on Medusa + Hotmart. Co-production split active.
```
...
<details>
<summary><strong>Do I need to know React to build modules?</strong></summary>
...
<details>
<summary><strong>How do I get paid?</strong></summary>
...
<details>
<summary><strong>What if I already have an audience?</strong></summary>
...
<details>
<summary><strong>Can I use my own payment gateway?</strong></summary>
...
<details>
<summary><strong>Is there an app review process?</strong></summary>
...
<details>
<summary><strong>What's the Usage Split?</strong></summary>
...
| ----------- | ---------------------------------------------------------------------- | -------------------------------- |
| **GitHub**  | [@LucassVal/Panda-Factory](https://github.com/LucassVal/Panda-Factory) | Code, issues, module submissions |
| **Reddit**  | Coming soon                                                            | Community, showcases, feedback   |
| **Discord** | Coming soon                                                            | Real-time support, dev chat      |

### How to Contribute

1. **Build a module** — Pick a niche, use the SDK, publish to the Store
2. **Report issues** — GitHub Issues for bugs and feature requests
3. **Translate** — Help expand i18n coverage (currently: 🇧🇷 PT-BR, 🇺🇸 EN, 🇪🇸 ES)
4. **Spread the word** — Star the repo, share with devs who want to earn more
