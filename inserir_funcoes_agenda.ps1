# Ler o arquivo HTML
$filePath = "C:\Users\Lucas Valério\Desktop\CRM\CRM.html"
$content = Get-Content $filePath -Raw

# Achar o local antes de </script> (antes da linha que contém renderizarTemplatesSettings)
$insertPoint = "      function renderizarTemplatesSettings()"

# Funções de agendamento para inserir
$agendaFunctions = @"

      // ========== FUNÇÕES DE AGENDAMENTO (SISTEMA COMPLETO) ==========
...
# Inserir as funções antes da função renderizarTemplatesSettings
$content = $content.Replace($insertPoint, $agendaFunctions + "`r`n" + $insertPoint)

# Salvar o arquivo
$content | Set-Content $filePath -NoNewline

Write-Host "✅ Funções de agendamento inseridas com sucesso!" -ForegroundColor Green
"@
