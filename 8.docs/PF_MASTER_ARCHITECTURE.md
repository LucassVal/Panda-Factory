...
│  ─────────────────────────────     │  ──────────────────────────     │
│  1.core/    GAS backend, PAT      │  11.jam/    JAM React source    │
...
git push panda main
# → Triggera GitHub Actions → build 11.jam/ → deploy dist/jam/ → GitHub Pages
```
...
```text
Push panda → GitHub Actions → npm ci (11.jam/) → npm run build →
