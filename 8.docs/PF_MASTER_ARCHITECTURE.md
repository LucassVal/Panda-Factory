...
│                          ┌────────▼────────┐                            │
│                          │   PANDA SDK     │  ← O "Colchão"             │
│                          │ (JS + Wasm Rust)│  ← [Shield de Segurança]   │
│                          └────────┬────────┘                            │
└───────────────────────────────────┼─────────────────────────────────────┘
                                    │
              ┌─────────────────────┼─────────────────────┐
...
### 5.2.D. Store → Checkout → Wasm Shield → GAS Pipeline

```text
[👤 USER]            [🏪 STORE / UI]         [🛡️ WASM SHIELD]           [☁️ GAS v3.0.0]          [🔥 FIREBASE]
    │                      │                        │                         │                        │
    │ 1. Browse Catalog ───▶│                        │                         │                        │
    │                      │ 2. GET catalog ─────────┼─────────────────────────▶│                        │
    │                      │                        │                         │ 3. Return catalog ──────▶│
    ...
    │ 5. Click "Buy" ──────▶│                        │                         │                        │
    │                      │ 6. Pedido de Compra ───▶│                         │                        │
    │                      │                        │ 7. Assina Payload (SHA) │                        │
    │                      │                        │ 8. POST STORE_PURCHASE ─▶│                        │
    │                      │                        │                         │ 9. Grant license ───────▶│
    │◀── 10. SUCCESS ──────│◀─────── Retorno ────────│◀────── Resposta ────────│                        │
    │                      │                        │                         │                        │
    │ 11. "Run Module" ────▶│                        │                         │                        │
    │                      │ 12. Valida DRM Local ──▶│                         │                        │
    │                      │                        │ 13. [Se OK] Load Tools ─▶│ (manifest)             │
    │◀── 14. Module Live ──│◀─────── Autorizado ─────│                         │                        │
```
