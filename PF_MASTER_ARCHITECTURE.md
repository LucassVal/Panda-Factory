...
🔧 INFRAESTRUTURA ───────────────────────────────────────────────────────
│
├── ☁️ GAS Backend (17 .gs files, Tri-Mode Dispatcher)
...
| [/]    | 5   | SDK Auth wiring (mock→Firebase Auth real)  | E1-S1A | §2. Hook / §4. SDK | 817-1002 / 1386-1434 | `SDK_REF §Auth`  |
...
| Status | #   | Task                                           | Etapa  | Seção Ref                   | Linhas                | Doc SSoT              |
| ------ | --- | ---------------------------------------------- | ------ | --------------------------- | --------------------- | --------------------- |
| [ ]    | 1   | Firebase RTDB Rules + Schema                   | E1-S1A | §5.2 Firebase RTDB          | 1559-1692             | `BACKEND_REF §7`      |
| [ ]    | 3   | GAS Deploy como Web App (doPost público)       | E1-S1A | §5.1 GAS Backend            | 1435-1558             | `GAS_REF`             |
| [ ]    | 4   | GAS Webhook handler Kiwify/Hotmart (funcional) | E1-S1A | §5.1 GAS Backend            | 1435-1558             | `SDK_REF`, `ECON_REF` |
| [ ]    | 6   | SDK Wallet wiring (mock→RTDB real)             | E1-S1A | §4. SDK / §5.2 Firebase     | 1386-1434 / 1559-1692 | `SDK_REF §Wallet`     |
| [ ]    | 7   | CSP + SRI + CORS security headers              | E1-S1A | §7. Segurança               | 2157-2496             | `SECURITY_REF`        |
| [ ]    | 12  | Chat AI funcional (Gemini 3.0 endpoint real)   | E1-S1C | §1.3 Brain / §5.1 GAS       | 58-63 / 1435-1558     | `GEMINI_REF`          |
...
| [ ]    | 15  | GAS Heartbeat + Cron triggers                  | E1-S1C | §5.2 Firebase (Heartbeat)   | 1709-1730             | `GAS_REF`             |
| [ ]    | 17  | Onboarding pulsing dots (Phase 2 Wizard)       | E1-S1D | §3. Frontend                | 1003-1385             | `CONTEXT.md §11`      |
...
| Status | #   | Task                                              | Etapa  | Seção Ref                     | Linhas                | Doc SSoT        |
| ------ | --- | ------------------------------------------------- | ------ | ----------------------------- | --------------------- | --------------- |
| [ ]    | 8   | PC Economy Real — compra de pacotes ($20-$5K)     | E1-S1B | §8. Tokenomics                | 2497-2739             | `ECON_REF §9.1` |
| [ ]    | 9   | Store Purchases Real — PC debit ao instalar       | E1-S1B | §8.4 Mercado / §11. Tentacles | 2605-2627 / 2765-2849 | `MEDUSA_REF`    |
| [ ]    | 10  | Anúncios para PC na Store (Featured/Sponsored)    | E1-S1B | §8. Tokenomics                | 2497-2739             | `MEDUSA_REF P4` |
...
| [ ]    | 41  | Casulo/BundleCreator (cross-platform packaging) | E4     | §15. App Factory         | 2905-3064             | `MEDUSA_REF`       |
...
| **E3** Flywheel     | Q3/26      | #30-37 | 1K users + Mining alpha + P2P discovery             |
| **E4** Escala       | Q4/26+     | #38-42 | 10K users + Token pipeline + P2P real               |
...
> | Status | #   | Task                                         | Etapa  | Doc SSoT              |
> | ------ | --- | -------------------------------------------- | ------ | --------------------- |
> | [ ]    | 1   | Firebase RTDB Rules + Schema                 | E1-S1A | `BACKEND_REF §7`      |
> | [ ]    | 3   | GAS Deploy como Web App (doPost público)     | E1-S1A | `GAS_REF`             |
...
## 15. App Factory - Democratização de Tecnologia 「E4 | 2 tasks | 0/2」
...
> | [ ]    | 41  | White-label engine                     | E4    | `MEDUSA_REF` |
