 ...
 *
 * v4.1 — Product Detail Page (PDP) + Embed Links + Dual Badge + Tier Badges
 */
...
const TIER_CONFIG = {
  ...
  freemium: { badge: '🔵 FREE+', color: '#3b82f6', border: 'rgba(59,130,246,0.3)' },
...
const STORE_ITEMS = [
  ...
  },
  {
    ...
    fullDescription: "Compose tweets, build threads, and track engagement — all from your Panda workspace.\n\nFeatures:\n• Tweet composer with AI suggestions\n• Thread builder\n• Engagement analytics\n• Mention monitoring",
    priceUSD: 4.99,
    price: 50,
    tier: "pro",
    storeCategory: "social",
...
function PFStore({
  ...
  const categories = [
    ...
    { id: "productivity", label: "📋 Productivity", count: STORE_ITEMS.filter((i) => i.storeCategory === "productivity").length },
    { id: "social", label: "📱 Social", count: STORE_ITEMS.filter((i) => i.storeCategory === "social").length },
    { id: "analytics", label: "📊 Analytics", count: STORE_ITEMS.filter((i) => i.storeCategory === "analytics").length },
    { id: "automation", label: "🤖 Automation", count: STORE_ITEMS.filter((i) => i.storeCategory === "automation").length },
    { id: "design", label: "🎨 Design", count: STORE_ITEMS.filter((i) => i.storeCategory === "design").length },
    { id: "ai", label: "🧠 AI", count: STORE_ITEMS.filter((i) => i.storeCategory === "ai").length },
    { id: "trading", label: "📈 Trading", count: STORE_ITEMS.filter((i) => i.storeCategory === "trading").length },
